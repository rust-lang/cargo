...
unstable_cli_options!(
    ...
    jobserver_fairness: bool = ("Enable eager release of jobserver tokens when no work is pending"),
    ...
    prerelease: bool = ("Allow selecting pre-release versions with `update --precise`"),
...
impl CliUnstable {
    ...
    fn add(&mut self, flag: &str, warnings: &mut Vec<String>) -> CargoResult<()> {
        ...
        match k {
            ...
            "jobserver-fairness" => self.jobserver_fairness = parse_empty(k, v)?,
            ...
            "prerelease" => self.prerelease = parse_empty(k, v)?,
