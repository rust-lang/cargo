...
pub fn detect_and_report(gtcx: &GlobalContext) -> CargoResult<()> {
    ...
    {
        use self::execution_policy::{
            EPDeveloperTool, EPDeveloperToolStatus, ExecutionPolicyHandle,
        };
        ...
        // TODO(madsmtm): We could possibly also try to compile a simple
        // binary here, run it twice, and compare the time it took?
        // Just as a way to verify if our checks above were actually correct.

        // TODO(madsmtm): Make a page in Cargo's docs that explains this in
        // more depth.

        // TODO(madsmtm): Iterate on the wording here.
        gtcx.shell().note(
