...
impl RustupToolchainSource {
    ...
    fn is_environment_override(&self) -> bool {
        matches!(self, Self::Environment)
    }

    fn is_command_line_override(&self) -> bool {
        matches!(self, Self::CommandLine)
    }

    fn is_current_dir_override(&self) -> bool {
        matches!(self, Self::OverrideDB)
    }

    fn is_toolchain_file_override(&self) -> bool {
        matches!(self, Self::ToolchainFile)
    }

    fn is_other_override(&self) -> bool {
