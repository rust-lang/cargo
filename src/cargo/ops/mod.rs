...
pub use self::cargo_rustc::{CommandType, CommandPrototype, ExecEngine};
pub use self::cargo_rustc::ProcessEngine;
...
pub use self::registry::{registry_login, search, http_proxy_exists};
pub use self::registry::http_handle;
