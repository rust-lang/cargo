...
- ❗️ Incremental compilation is now disabled by default when running in CI.
  CI is detected via the `CI` environment variable.
  [#17220](https://github.com/rust-lang/cargo/pull/17220)
- ❗️ Workspace members on edition 2024 or later can now override an inherited
  workspace dependency's `default-features` field.
  For example, `serde = { workspace = true, default-features = false }`
  now turns off default features even when the workspace definition enables them.
...
- Cargo now warns on hyphenated lint names in the `[lints]` table,
  e.g. `unexpected-cfgs` is deprecated in favor of `unexpected_cfgs`.
  Hyphenated names will not work in a future edition.
  [#17051](https://github.com/rust-lang/cargo/pull/17051)
- Use `LIBRARY_PATH` as the dynamic library search path env var on Haiku.
  [#17248](https://github.com/rust-lang/cargo/pull/17248)
- Various performance improvements,
  including using `FxHasher` for hash maps and sets,
  and avoiding redundant allocations for manifest and registry index parsing.
...
- Git fetch transports are now initialized only when used.
  This speeds up Cargo startup.
  [#17226](https://github.com/rust-lang/cargo/pull/17226)
...
- Make Git dependency checkout names independent of the user's `core.abbrev` git config.
  [#17289](https://github.com/rust-lang/cargo/pull/17289)
- When `net.git-fetch-with-cli` is set,
  git's fetch output is now hidden unless progress is being shown.
  [#17243](https://github.com/rust-lang/cargo/pull/17243)
- Add a suggestion when adding `[lints]` to a virtual workspace to use `[workspace.lints]` instead
  [#17300](https://github.com/rust-lang/cargo/pull/17300)
- Cargo now uses the more accurate 'highest' rather than 'latest'
  when reporting dependency changes.
  [#17317](https://github.com/rust-lang/cargo/pull/17317)
- Clarify the error message when a path dependency has a wrong or missing package
  [#16927](https://github.com/rust-lang/cargo/pull/16927)
...
- Add `-p` and `--package` flags for `cargo add` zsh completion
  [#17247](https://github.com/rust-lang/cargo/pull/17247)
- Avoid use of git's `core.fsmonitor` when `net.git-fetch-with-cli` is set.
  [#17306](https://github.com/rust-lang/cargo/pull/17306)
- Cargo timing only reports units the job queue actually ran.
  [#17238](https://github.com/rust-lang/cargo/pull/17238)
- Prevent panic when `package.build` is empty
  [#17268](https://github.com/rust-lang/cargo/pull/17268)
- Prevent incorrect duplicate package warning
  when `CARGO_HOME` contains relative `..` path segments.
  [#17204](https://github.com/rust-lang/cargo/pull/17204)
- cargo-clean: Fixed `cargo clean --doc` not cleaning `target/<triple>/doc/`
  directory when a target platform is explicitly requested.
  [#17322](https://github.com/rust-lang/cargo/pull/17322)

### Nightly only

- `native-completions`: complete paths for cargo run arguments
  [#17284](https://github.com/rust-lang/cargo/pull/17284)
- `native-completions`: don't panic during completions when rustup is unavailable
  [#17263](https://github.com/rust-lang/cargo/pull/17263)
- `rustdoc-output-format`: document the `--output-format` for `cargo doc`.
  [#17325](https://github.com/rust-lang/cargo/pull/17325)
- `update-breaking`: remove stray `directory` metavar from `cargo update --breaking` option
  [#17319](https://github.com/rust-lang/cargo/pull/17319)
...
- `-Zbuild-analysis`: emit build-started JSON message with run_id
  [#16632](https://github.com/rust-lang/cargo/pull/16632)
- `-Zbuild-dir-new-layout`: Reworked how we enable the new build-dir layout on nightly
  [#17272](https://github.com/rust-lang/cargo/pull/17272)
- `-Zbuild-dir-new-layout`: Enable build-dir layout v2 on nightly by default
  [#17258](https://github.com/rust-lang/cargo/pull/17258)
- `-Zbuild-dir-new-layout`: Reduce rustc `-L` args used in the new `build-dir` layout
  [#17168](https://github.com/rust-lang/cargo/pull/17168)
- `-Zbuild-dir-new-layout`: Do not include proc-macro deps in rustc search path args
  [#17236](https://github.com/rust-lang/cargo/pull/17236)
- `-Zcargo-lints`: Remove complexity, perf, and nursery lint groups
  [#17307](https://github.com/rust-lang/cargo/pull/17307)
- `-Zcargo-lints`: Ensure diagnostic titles work without snippets
  [#17304](https://github.com/rust-lang/cargo/pull/17304)
- `-Zcargo-lints`: bound transitive unused dependency traversal
  [#17251](https://github.com/rust-lang/cargo/pull/17251)
- `-Zcargo-lints`: Rename redundant_readme to manual_readme
  [#17288](https://github.com/rust-lang/cargo/pull/17288)
- `-Zcargo-lints`: Fix manual_readme lint for lower-priority README files
  [#17208](https://github.com/rust-lang/cargo/pull/17208)
- `-Zcargo-lints`: Remove `new_implicit_minimum_version_req` (#16321)
  [#17249](https://github.com/rust-lang/cargo/pull/17249)
- `-Zcargo-lints`: Gate blanket_hint_mostly_unused with -Zprofile-hint-mostly-unused
  [#17313](https://github.com/rust-lang/cargo/pull/17313)
- `-Zcargo-lints`: add context to lints documentation
  [#17273](https://github.com/rust-lang/cargo/pull/17273)
- `-Zcargo-lints`: Better match clippy in lint section titles
  [#17190](https://github.com/rust-lang/cargo/pull/17190)
- `-Zcargo-lints`: Clarify MSRV for lints
  [#17184](https://github.com/rust-lang/cargo/pull/17184)
- `-Zembed-metadata`: Allow setting `-Zembed-metadata` value from the config
  [#17266](https://github.com/rust-lang/cargo/pull/17266)
- `-Zembed-metadata`: Rename `-Zno-embed-metadata` to `-Zembed-metadata=no`
  [#17149](https://github.com/rust-lang/cargo/pull/17149)
- `-Zmin-publish-age`: Report the min-publish-age in the lock message
  [#17328](https://github.com/rust-lang/cargo/pull/17328)
- `-Zmin-publish-age`: Make min-publish-age relative to `--publish-time`
  [#17327](https://github.com/rust-lang/cargo/pull/17327)
- `-Zrustdoc-mergeable-info`: don't use mergeable info and json together
  [#17336](https://github.com/rust-lang/cargo/pull/17336)
- `-Zrustdoc-mergeable-info`: Pass rustdoc flags to the final CCI merge step
  [#17269](https://github.com/rust-lang/cargo/pull/17269)
- `-Zrustdoc-mergeable-info`: rename the doc parts metadata params
  [#17234](https://github.com/rust-lang/cargo/pull/17234)
- `-Zsbom`: Include SBOM outputs in fingerprints
  [#17216](https://github.com/rust-lang/cargo/pull/17216)
- `-Ztrim-paths`: honor workspace prefix override from env
  [#17349](https://github.com/rust-lang/cargo/pull/17349)
- `-Ztrim-paths`: workspace remap under `-Zroot-dir`
  [#17337](https://github.com/rust-lang/cargo/pull/17337)
- `-Ztrim-paths`: unambiguous and reversible remap rules
  [#17302](https://github.com/rust-lang/cargo/pull/17302)
  [#17338](https://github.com/rust-lang/cargo/pull/17338)
- `-Ztrim-paths`: emit unremap files for final artifacts
  [#17303](https://github.com/rust-lang/cargo/pull/17303)
  [#17326](https://github.com/rust-lang/cargo/pull/17326)
- `-Ztrim-paths`: gate trim-paths tests on split debuginfo support
  [#17256](https://github.com/rust-lang/cargo/pull/17256)
- `-Ztrim-paths`: re-enable lldb debugger tests
  [#17223](https://github.com/rust-lang/cargo/pull/17223)
- `-Ztrim-paths`: exercise GDB on windows-gnu
  [#17221](https://github.com/rust-lang/cargo/pull/17221)

### Documentation

- Add recommended structure to members field in workspace chapter.
  [#17166](https://github.com/rust-lang/cargo/pull/17166)
- Make room for the new `debug` profile by clarifying the behavior around `test` and `bench` profiles.
  [#17213](https://github.com/rust-lang/cargo/pull/17213)
- Add missing config env variables
  [#17345](https://github.com/rust-lang/cargo/pull/17345)
- cargo-fetch: remove cargo-prefetch reference
  [#16568](https://github.com/rust-lang/cargo/pull/16568)
- cargo-install: Move `--debug` to Compilation options
  [#17199](https://github.com/rust-lang/cargo/pull/17199)
...
- Flatten Cargo's own package layout
  ...
  [#17233](https://github.com/rust-lang/cargo/pull/17233)
- Make `__CARGO_TEST_FORCE_ARGFILE` available in distributed builds
  [#17293](https://github.com/rust-lang/cargo/pull/17293)
- cargo-util-schemas: Fix `TomlDebugInfo` enum variants not being renamed
  [#17202](https://github.com/rust-lang/cargo/pull/17202)
- ci: Use a 3-day minimum release age
  [#17346](https://github.com/rust-lang/cargo/pull/17346)
- ci: remove stale libsecret packages
  [#17229](https://github.com/rust-lang/cargo/pull/17229)
- ci: dogfood `build.warnings`
  [#17195](https://github.com/rust-lang/cargo/pull/17195)
- test: exercise multi git revision lockfile
  [#17279](https://github.com/rust-lang/cargo/pull/17279)
- test: Explicitly test for git injection attacks
  [#17253](https://github.com/rust-lang/cargo/pull/17253)
- Update dependencies.
  [#17192](https://github.com/rust-lang/cargo/pull/17192)
  [#17225](https://github.com/rust-lang/cargo/pull/17225)
  [#17237](https://github.com/rust-lang/cargo/pull/17237)
  [#17259](https://github.com/rust-lang/cargo/pull/17259)
  [#17290](https://github.com/rust-lang/cargo/pull/17290)
  [#17291](https://github.com/rust-lang/cargo/pull/17291)
  [#17297](https://github.com/rust-lang/cargo/pull/17297)
...
- 🎉 Stabilize `build.warnings` config.
  This controls how lint warnings from local packages are treated.
  Useful for enforcing a warning-free build in CI, replacing `-Dwarnings`.
  [docs](https://doc.rust-lang.org/nightly/cargo/reference/config.html#buildwarnings)
  [#16796](https://github.com/rust-lang/cargo/pull/16796)
  [#16961](https://github.com/rust-lang/cargo/pull/16961)
- 🎉 Stabilize `resolver.lockfile-path` config.
  This allows specifying the path to the lockfile to use when resolving dependencies.
  Useful when working with read-only source directories.
  [docs](https://doc.rust-lang.org/nightly/cargo/reference/config.html#resolverlockfile-path)
  [#16694](https://github.com/rust-lang/cargo/pull/16694)
- Add `-m` shorthand for `--manifest-path`
  [#16858](https://github.com/rust-lang/cargo/pull/16858)
  [#16888](https://github.com/rust-lang/cargo/pull/16888)

### Changed

- Suggest `fmt` when user types `cargo rustfmt`.
  [#16985](https://github.com/rust-lang/cargo/pull/16985)
- Add `$comment` to `.cargo-checksum.json` to clarify this file is not a security mechanism.
  [#16967](https://github.com/rust-lang/cargo/pull/16967)
...
- Fix `[env]` relative paths being resolved against the wrong config file
  when merged via `include`.
  [#16957](https://github.com/rust-lang/cargo/pull/16957)
- Normalize `..` in included config paths so relative paths resolve correctly.
  [#16964](https://github.com/rust-lang/cargo/pull/16964)
- cargo-clean: do not error if explicitly specified target-dir does not exist
  [#16934](https://github.com/rust-lang/cargo/pull/16934)
- cargo-clean: respect `build.target` config
  [#16988](https://github.com/rust-lang/cargo/pull/16988)
...
- rustdoc-output-format: rebuild rustdoc json for different versions of a same crate
  [#16773](https://github.com/rust-lang/cargo/pull/16773)
  [#16968](https://github.com/rust-lang/cargo/pull/16968)
- `-Zscript`: Teach users how to pin edition
  [#16851](https://github.com/rust-lang/cargo/pull/16851)
- `-Zcargo-lints`: Add deny-by-default `text_direction_codepoint` lints
  [#16950](https://github.com/rust-lang/cargo/pull/16950)
...
- `-Zcargo-lints`: Where possible, hint about misplaced deps
  [#16940](https://github.com/rust-lang/cargo/pull/16940)
- `-Zcargo-lints`: Ignore unused deps if also transitive
  [#16935](https://github.com/rust-lang/cargo/pull/16935)
- `-Zcargo-lints`: Log all ignored unused externs
  [#16920](https://github.com/rust-lang/cargo/pull/16920)
- `-Zcargo-lints`: Instrument lints for logging
  [#16972](https://github.com/rust-lang/cargo/pull/16972)
- `-Zcargo-lints`: Consolidate verify/run diagnostics passes
  [#16989](https://github.com/rust-lang/cargo/pull/16989)
- `-Zcargo-lints`: Track Cargo diagnostic warning/error count like is done for rustc
  [#16981](https://github.com/rust-lang/cargo/pull/16981)
- `-Zcargo-lints`: consolidate lints infrastructure to touch fewer files
  in preparation of a new "how to write a lint" guide
  [#16975](https://github.com/rust-lang/cargo/pull/16975)
  [#16976](https://github.com/rust-lang/cargo/pull/16976)
  [#16978](https://github.com/rust-lang/cargo/pull/16978)
- `-Zjson-target-spec`: rename incorrectly documented `target-spec-json` to `json-target-spec`
  [#16905](https://github.com/rust-lang/cargo/pull/16905)
- `-Zpublic-dependency`: Rebuild when toggling `-Zpublic-dependency` flag
  [#16965](https://github.com/rust-lang/cargo/pull/16965)
...
- Clarified `.cargo-checksum.json` is not a security mechanism
  [#16966](https://github.com/rust-lang/cargo/pull/16966)
- Clarified that if `include` is specified,
  gitignore rules of the repo and global git config are not applied.
  [#16890](https://github.com/rust-lang/cargo/pull/16890)
- Switch from third-party to first-party unused deps detection
  [#16946](https://github.com/rust-lang/cargo/pull/16946)
- cargo-update: clarified `--precise <yanked>` is on stable
  [#16944](https://github.com/rust-lang/cargo/pull/16944)
- cargo-package: Better highlight `--list` for include/exclude
  [#16891](https://github.com/rust-lang/cargo/pull/16891)

### Internal

- Convert more network operations to async,
  including GitHub fast path and `.crate` downloads.
  [#16899](https://github.com/rust-lang/cargo/pull/16899)
  [#16900](https://github.com/rust-lang/cargo/pull/16900)
  [#16898](https://github.com/rust-lang/cargo/pull/16898)
  [#16902](https://github.com/rust-lang/cargo/pull/16902)
  [#16903](https://github.com/rust-lang/cargo/pull/16903)
  [#16909](https://github.com/rust-lang/cargo/pull/16909)
  [#16912](https://github.com/rust-lang/cargo/pull/16912)
- Remove `curl` dependency from `crates-io` crate
  [#16936](https://github.com/rust-lang/cargo/pull/16936)
- Remove `windows-sys` dependency from `home`
  [#16918](https://github.com/rust-lang/cargo/pull/16918)
- Use `portable-atomic` for 64-bit atomics
  [#16906](https://github.com/rust-lang/cargo/pull/16906)
- build-rs: Ensure we lint the crate
  [#16930](https://github.com/rust-lang/cargo/pull/16930)
...
- ci: update to macos-15
  [#16996](https://github.com/rust-lang/cargo/pull/16996)
- ci: Use `actions/deploy-pages` for Cargo Contributor Guide deployment
  [#16876](https://github.com/rust-lang/cargo/pull/16876)
- test: Add test for cargo install with github fastpath
  [#16866](https://github.com/rust-lang/cargo/pull/16866)
- test: Fix flaky tests
  [#16914](https://github.com/rust-lang/cargo/pull/16914)
  [#16915](https://github.com/rust-lang/cargo/pull/16915)
  [#16916](https://github.com/rust-lang/cargo/pull/16916)
  [#16922](https://github.com/rust-lang/cargo/pull/16922)
- test: cover search API redirects
  [#16971](https://github.com/rust-lang/cargo/pull/16971)
- test: add regression test for full-hash GitHub fast path
  [#16919](https://github.com/rust-lang/cargo/pull/16919)
- Update dependencies.
  [#16883](https://github.com/rust-lang/cargo/pull/16883)
  [#16897](https://github.com/rust-lang/cargo/pull/16897)
  [#16931](https://github.com/rust-lang/cargo/pull/16931)
  [#16932](https://github.com/rust-lang/cargo/pull/16932)
  [#16938](https://github.com/rust-lang/cargo/pull/16938)
  [#16941](https://github.com/rust-lang/cargo/pull/16941)
  [#16945](https://github.com/rust-lang/cargo/pull/16945)
  [#16952](https://github.com/rust-lang/cargo/pull/16952)
...
- Shell completions complete `--config` and `--color` before command.
  [#16780](https://github.com/rust-lang/cargo/pull/16780)
- Split `build-dir` concurrency file lock into a dedicated lock
  while keeping a shared lock on `.cargo-lock` for running new
  and old Cargo concurrently on the same target directory.
  [#16708](https://github.com/rust-lang/cargo/pull/16708)
  [#16887](https://github.com/rust-lang/cargo/pull/16887)
- Dependency multiple locations now supports `git` with alternate registries.
  For example, `{ git = "https://...", registry = "my-registry" }`.
  [#16810](https://github.com/rust-lang/cargo/pull/16810)
- `term.progress.term-integration` detects Ptyxis terminal support.
...
- Exclude target directory from iCloud Drive sync on macOS
  [#16728](https://github.com/rust-lang/cargo/pull/16728)
- Set `CARGO` env var during `rustc -vV` target discovery probe
  [#16811](https://github.com/rust-lang/cargo/pull/16811)
- Hint at the expected auth scheme when a token is rejected by an alternate registry.
...
- cargo-clean: Validate that target directory is not a file
  [#16765](https://github.com/rust-lang/cargo/pull/16765)
- cargo-install: Warn when installing with a non-default toolchain
  [#16131](https://github.com/rust-lang/cargo/pull/16131)
- cargo-publish: Send `Content-Type: application/octet-stream` header with API requests
  [#16832](https://github.com/rust-lang/cargo/pull/16832)
- cargo-tree: clarify error message when `-i` is used without a package name
...
- Fix fetching git dependencies with non-default refspecs from
  non-GitHub hosts after a lockfile is created.
  [#16768](https://github.com/rust-lang/cargo/pull/16768)
- Fix panic when a package URL spec has a trailing `#` with no version.
  [#16754](https://github.com/rust-lang/cargo/pull/16754)
- cargo-publish: Fix silently hanging and timeout on circular dependency cycles in workspace publish.
...
- `native-completions`: complete `--config` argument
  [#16249](https://github.com/rust-lang/cargo/pull/16249)
- `-Zbuild-dir-new-layout`: Simplified build script bin names in new layout
  [#16812](https://github.com/rust-lang/cargo/pull/16812)
  [#16855](https://github.com/rust-lang/cargo/pull/16855)
- `-Zbuild-std`: ignore implicit std dependencies in `unused-crate-dependencies` lint
  [#16677](https://github.com/rust-lang/cargo/pull/16677)
- `-Zcargo-lints`: Add `unused_dependencies` lint
  [#16600](https://github.com/rust-lang/cargo/pull/16600)
- `-Zlockfile-path`: cargo-install ignores `resolver.lockfile-path`
...
- `-Zscript`: suppress `unused_features` lint for embedded
  [#16714](https://github.com/rust-lang/cargo/pull/16714)
- `-Zscript`: Force script edition warnings on quiet
  [#16848](https://github.com/rust-lang/cargo/pull/16848)
- `-Zjson-target-spec`: mention this is a cargo Z flag in error message
  [#16793](https://github.com/rust-lang/cargo/pull/16793)
- `-Zwarnings`: `build.warnings=allow` should not hide denied diagnostics and hard warnings
  [#16824](https://github.com/rust-lang/cargo/pull/16824)
  [#16827](https://github.com/rust-lang/cargo/pull/16827)
- `-Zwarnings`: Make build.warnings ignore non-local deps
  [#16760](https://github.com/rust-lang/cargo/pull/16760)
- `-Zwarnings`: Stop on denying warnings without `--keep-going`
  [#16725](https://github.com/rust-lang/cargo/pull/16725)
- `-Zwarnings`: Turn warning summaries into errors also
  [#16721](https://github.com/rust-lang/cargo/pull/16721)

### Documentation

- Clarified `CARGO_TARGET_DIR` doesn't have to be relative
  [#16735](https://github.com/rust-lang/cargo/pull/16735)
- Clarified build script current directory
  [#16703](https://github.com/rust-lang/cargo/pull/16703)
- List the minimum required MSRV for the unstable `public` field in dependencies
  [#16841](https://github.com/rust-lang/cargo/pull/16841)

### Internal

- 🎉 New member crate [`cargo-util-terminal`](https://crates.io/crates/cargo-util-terminal)!
  This contains Cargo's terminal rendering utilities,
  including shell output, styling, and diagnostics reporting.
...
- Export public dependencies from internal crates
  [#16819](https://github.com/rust-lang/cargo/pull/16819)
- Pull out hyperlink logic into new `anstyle-hyperlink` package
  [#16749](https://github.com/rust-lang/cargo/pull/16749)
- Pull out term integration into a new `anstyle-progress` package
  [#16757](https://github.com/rust-lang/cargo/pull/16757)
- Let git decide when to run `git gc` instead of manually counting packfiles.
  [#16459](https://github.com/rust-lang/cargo/pull/16459)
- cargo-test-support: strip `RUSTUP_TOOLCHAIN_SOURCE` from test environment
  [#16857](https://github.com/rust-lang/cargo/pull/16857)
- cargo-test-support: Fix `symlink_and_directory` with long target dir paths.
  [#16775](https://github.com/rust-lang/cargo/pull/16775)
- ci: Detect user changes to src/etc/man
  [#16736](https://github.com/rust-lang/cargo/pull/16736)
- ci: update cargo-semver-checks to v0.47.0
