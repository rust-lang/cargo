...
> [!NOTE]
> There is another special style of test in Cargo:
...
> [!NOTE]
> Examples are built by [`cargo test`] by default to ensure they
...
> [!NOTE]
> The binary will be skipped if its name is the same as the lib
> target.
...
> [!NOTE]
> For packages with the 2015 edition, the default for auto-discovery
