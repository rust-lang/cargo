...
fn ignore_version_from_other_platform() {
    ...
    let p = project("a")
        .file("Cargo.toml", &format!(r#"
            ...
            [target.'cfg({})'.dependencies]
            foo = "0.1.0"
            bar = {{ git = "https://github.com/rust-lang/libc", rev = "89ddad83ff8ec43437fdd0fae72cc23e8247208a" }}

            [target.'cfg({})'.dependencies]
            foo = "0.2.0"
            bar = {{ git = "https://github.com/rust-lang/libc", rev = "b3676593f6930c32d947c59e210789bbfcb30960" }}
