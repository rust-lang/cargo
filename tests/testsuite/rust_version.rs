...
[ERROR] failed to parse manifest at `[ROOT]/foo/Cargo.toml`
  |
  = caused by: rust-version 1.1 is older than first version (1.31.0) required by the specified edition (2018)
...
[ERROR] rustc [..] is not supported by the following packages:
       ...
       where `<compatible-ver>` is the latest version supporting rustc 1.91.0-nightly
