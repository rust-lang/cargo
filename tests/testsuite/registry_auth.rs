...
[ERROR] failed to get `bar` as a dependency of package `foo v0.0.1 ([ROOT]/foo)`
  ...
  = caused by: failed to get successful HTTP response from `http://127.0.0.1:34225/index/config.json`, got 401
               body:
...
[ERROR] failed to get `bar` as a dependency of package `foo v0.0.1 ([ROOT]/foo)`
  ...
  = caused by: token rejected for `alternative`, please run `cargo login --registry alternative`
               or use environment variable CARGO_REGISTRIES_ALTERNATIVE_TOKEN
  = caused by: failed to get successful HTTP response from `http://127.0.0.1:43847/index/config.json`, got 401
               body:
               Unauthorized message from server.
...
[ERROR] failed to get `bar` as a dependency of package `foo v0.0.1 ([ROOT]/foo)`
  ...
  = caused by: token rejected for `alternative`, please run `cargo login --registry alternative`
               or use environment variable CARGO_REGISTRIES_ALTERNATIVE_TOKEN
  = caused by: failed to get successful HTTP response from `http://127.0.0.1:45003/index/config.json`, got 401
               body:
               Unauthorized message from server.
...
[ERROR] failed to get `bar` as a dependency of package `foo v0.0.1 ([ROOT]/foo)`
  ...
  = caused by: token rejected for `alternative`, please run `cargo login --registry alternative`
               or use environment variable CARGO_REGISTRIES_ALTERNATIVE_TOKEN
  = caused by: failed to get successful HTTP response from `http://127.0.0.1:35389/index/config.json`, got 401
               body:
               Unauthorized message from server.
...
[ERROR] failed to download from `http://127.0.0.1:[..]/dl/bar/0.0.1/download`
  |
  = caused by: failed to get successful HTTP response from `http://127.0.0.1:38225/dl/bar/0.0.1/download` (127.0.0.1), got 401
               body:
               Unauthorized message from server.
...
[ERROR] no token found for `sparse+http://127.0.0.1:[..]/index/`
       ...
       [registries]
       my-registry = { index = "sparse+http://127.0.0.1:45293/index/" }
