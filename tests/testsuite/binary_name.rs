...
[ERROR] failed to parse manifest at `[ROOT]/foo/Cargo.toml`
  ...
  = caused by: feature `different-binary-name` is required
               ...
               The package requires the Cargo feature called `different-binary-name`, but that feature is not stabilized in this version of Cargo (1.91.0 (3eafc35f1 2025-09-03)).
