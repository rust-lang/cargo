...
[ERROR] failed to get `bar` as a dependency of package `foo v0.1.0 ([ROOT]/foo)`
  ...
  = caused by: failed to get successful HTTP response from `http://127.0.0.1:39709/index/3/b/bar` (127.0.0.1), got 503
               debug headers:
               x-amz-cf-pop: SFO53-P2
               x-amz-cf-id: vEc3osJrCAXVaciNnF4Vev-hZFgnYwmNZtxMKRJ5bF6h9FTOtbTMnA==
               x-cache: Hit from cloudfront
...
[ERROR] failed to download from `http://127.0.0.1:[..]/dl/bar/1.0.0/download`
  |
  = caused by: failed to get successful HTTP response from `http://127.0.0.1:37963/dl/bar/1.0.0/download` (127.0.0.1), got 503
               debug headers:
               x-amz-cf-pop: SFO53-P2
               x-amz-cf-id: vEc3osJrCAXVaciNnF4Vev-hZFgnYwmNZtxMKRJ5bF6h9FTOtbTMnA==
               x-cache: Hit from cloudfront
