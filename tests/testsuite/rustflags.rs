...
[RUNNING] `rustc --crate-name foo [..] --cfg bar --force-warn=unused_crate_dependencies`
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [ELAPSED]s
...
"#]])
    ...
    p.cargo("build --bin=a -v")
        .with_stderr_data(str![[r#"
[COMPILING] foo v0.0.1 ([ROOT]/foo)
[RUNNING] `rustc --crate-name a [..] --cfg bar --force-warn=unused_crate_dependencies`
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [ELAPSED]s
...
"#]])
    ...
    p.cargo("build --example=b -v")
        .with_stderr_data(str![[r#"
[COMPILING] foo v0.0.1 ([ROOT]/foo)
[RUNNING] `rustc --crate-name b [..] --cfg bar --force-warn=unused_crate_dependencies`
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [ELAPSED]s
...
"#]])
    ...
    p.cargo("test --no-run -v")
        .with_stderr_data(str![[r#"
[COMPILING] foo v0.0.1 ([ROOT]/foo)
[RUNNING] `rustc [..] --cfg bar --force-warn=unused_crate_dependencies`
[RUNNING] `rustc [..] --cfg bar --force-warn=unused_crate_dependencies`
[RUNNING] `rustc [..] --cfg bar --force-warn=unused_crate_dependencies`
...
[RUNNING] `rustc --crate-name foo [..] --cfg foo --force-warn=unused_crate_dependencies`
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [ELAPSED]s
