...
fn discovery_inferred_build_rs_included() {
    ...
    p.cargo("package")
        .with_stdout("")
        .with_stderr(
            r#"[PACKAGING] foo v0.0.1 ([ROOT]/foo)
...
[COMPILING] foo v0.0.1 ([ROOT]/foo/target/package/foo-0.0.1)
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [..]s
[PACKAGED] 3 files, [..]B ([..]B compressed)
"#,
        )
        .run();
...
[COMPILING] foo v0.0.1 ([ROOT]/foo/target/package/foo-0.0.1)
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [..]s
[PACKAGED] 5 files, [..]B ([..]B compressed)
"#,
        )
        .run();
...
[COMPILING] foo v0.0.1 ([ROOT]/foo/target/package/foo-0.0.1)
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [..]s
[PACKAGED] 8 files, [..]B ([..]B compressed)
"#,
        )
        .run();
...
fn discovery_inferred_other_excluded() {
    ...
    p.cargo("package")
        .with_stdout("")
        .with_stderr(r#"[PACKAGING] foo v0.0.1 ([ROOT]/foo)
