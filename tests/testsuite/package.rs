...
src/main.rs
target/foo.txt
target/package/tmp-registry/.cargo-lock
",
        )
        .run();
...
fn workspace_with_local_deps() {
    ...
    p.cargo("package")
        ...
        .with_stderr(
            "\
[PACKAGING] level3 v0.0.1 ([CWD]/level3)
[PACKAGED] 3 files, [..] ([..] compressed)
...
[PACKAGED] 4 files, [..] ([..] compressed)
[VERIFYING] level3 v0.0.1 ([CWD]/level3)
[COMPILING] level3 v0.0.1 ([CWD][..])
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [..]
[VERIFYING] level2 v0.0.1 ([CWD]/level2)
[UNPACKING] level3 v0.0.1 (registry `[CWD]/target/package/tmp-registry`)
[COMPILING] level3 v0.0.1
[COMPILING] level2 v0.0.1 ([CWD][..])
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [..]
[VERIFYING] level1 v0.0.1 ([CWD]/level1)
[UNPACKING] level2 v0.0.1 (registry `[CWD]/target/package/tmp-registry`)
[COMPILING] level3 v0.0.1
[COMPILING] level2 v0.0.1
[COMPILING] level1 v0.0.1 ([CWD][..])
[FINISHED] `dev` profile [unoptimized + debuginfo] target(s) in [..]
",
        )
        .run();
...
Caused by:
  ...
  required by package `level1 v0.0.1 ([CWD]/target/package/level1-0.0.1)`
",
        )
        .run();
}
...
[FINISHED] [..]
[VERIFYING] main v0.0.1 ([CWD]/main)
[DOWNLOADING] crates ...
[UNPACKING] dep v0.1.0 (registry [..])
[DOWNLOADED] dep v0.0.1
[COMPILING] dep [..]
[COMPILING] dep [..]
[COMPILING] main v0.0.1 ([..])
[FINISHED] [..]
",
        )
        .run();
