...
Caused by:
  process didn't exit successfully: `[ROOT]/foo/target/debug/build/foo/[HASH]/out/build_script_build2` ([EXIT_STATUS]: 101)
...
"#]])
        .run();
}
...
[COMPILING] foo v0.1.0 ([ROOT]/foo)
[RUNNING] `[ROOT]/foo/target/debug/build/foo/[HASH]/out/build_script_build1`
