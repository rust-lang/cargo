...
fn bad_target_name_project(target: &str, name: &str) -> Project {
    project()
        .file(
            "Cargo.toml",
            &format!(
...
"#
        ...
        .file("src/lib.rs", "")
        .file(format!("{target}/{name}"), "")
        .build()
}

#[cargo_test]
fn bad_bin_name() {
    bad_target_name_project("bin", "bin.rs")
        .cargo("check")
        .with_status(101)
        .with_stderr_data(str![[r#"
[ERROR] failed to parse manifest at `[ROOT]/foo/Cargo.toml`
...
#[cargo_test]
fn bad_example_name() {
    bad_target_name_project("example", "example.rs")
        .cargo("check")
        .with_status(101)
        .with_stderr_data(str![[r#"
[ERROR] failed to parse manifest at `[ROOT]/foo/Cargo.toml`
...
#[cargo_test]
fn bad_test_name() {
    bad_target_name_project("test", "test.rs")
        .cargo("check")
        .with_status(101)
        .with_stderr_data(str![[r#"
[ERROR] failed to parse manifest at `[ROOT]/foo/Cargo.toml`
...
#[cargo_test]
fn bad_bench_name() {
    bad_target_name_project("bench", "bench.rs")
        .cargo("check")
        .with_status(101)
        .with_stderr_data(str![[r#"
[ERROR] failed to parse manifest at `[ROOT]/foo/Cargo.toml`
