...
[RUNNING] \
                                          `rustdoc --crate-name foo src[/]lib.rs -o \
                                          {dir}[/]target[/]doc -L \
...
[RUNNING] `rustdoc --crate-name foo \
                                          src[/]lib.rs -o {dir}[/]target[/]doc --no-defaults \
                                          -L dependency={dir}[/]target[/]debug[/]deps --extern \
                                          [..]`
...
fn rustdoc_only_bar_dependency() {
    ...
    assert_that(foo.cargo_process("rustdoc")
                    .arg("-v")
                    .arg("-p")
                    .arg("bar")
                    .arg("--")
...
[RUNNING] `rustdoc \
                                          --crate-name bar [..]bar[/]src[/]lib.rs -o \
                                          {dir}[/]target[/]doc --no-defaults -L \
                                          dependency={dir}[/]target[/]debug[/]deps`
[FINISHED] \
                                          dev [unoptimized + debuginfo] target(s) in [..]
...
fn rustdoc_same_name_err() {
    ...
    assert_that(p.cargo_process("rustdoc")
                    .arg("-v")
                    .arg("--")
                    .arg("--no-defaults"),
                execs()
